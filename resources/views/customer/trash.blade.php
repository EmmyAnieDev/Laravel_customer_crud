        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <form action=" {{ route('customers.index') }} " class="form-order">
                            <div class="input-group mb-3">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:;" onclick=" if(confirm('Are you sure you want to delete?')) $('.form-{{ $customer->id }}').submit()" style="color: #2c2c2c;" class="ms-1 me-1"><i class="fas fa-trash-alt"></i></a>
                            <form class=" form-{{ $customer->id }} " action=" {{ route('customers.force_destroy', $customer->id ) }} " method="POST">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
